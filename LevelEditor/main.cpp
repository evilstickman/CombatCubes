...
LevelMap * testMap = new LevelMap();
  ...
  Grid g(0, WIDTH, 11, 0, HEIGHT, 11, 0.0, 1.0,1);
                   ...
                   LPSTR lpCmdLine, int iCmdShow)
{
  ...
  GraphicsApplication *gApp = new OpenGLWindowsApplication(WIDTH, HEIGHT,
    ...
    WndProc, iCmdShow, L"Combat Cubes - Level Editor");
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam )
{
  ...
  case WM_LBUTTONUP:
      ...
      swprintf(ibuf,100, L"You clicked the left mouse button at position %d,%d", xpos, ypos);
      MessageBox(hwnd, ibuf, L"MESSAGE FOR YOU SIR", MB_OK);
      break;
